...
class FieldSummaryTemplate extends HTMLParserBase
{
    ...
    public function ParseContent()
    {
        ...
        $options->ShowEmptyFields=Sanitizer::GetBooleanValueFromPath($options,['ShowEmptyFields'],false);

        if($options->Format=="same_as_form")
            return new RawHTMLParser($this->FormBuilder,$this->Parent,null, $this->FormBuilder->ContainerManager->GetHtml($this->GetDocument()->Context,$options));
        else
